...
class ChargeLocationClusterAnnotationView: MKAnnotationView {
    ...
    private func drawRatioBicycleToTricycle(_ tricycleCount: Int, to totalBikes: Int) -> UIImage {
        return drawRatio(tricycleCount, to: totalBikes, fractionColor: UIColor.availableColor, wholeColor: UIColor.occupiedColor)
    }

    private func drawUnicycleCount(count: Int) -> UIImage {
        return drawRatio(0, to: count, fractionColor: nil, wholeColor: UIColor.occupiedColor)
    }
